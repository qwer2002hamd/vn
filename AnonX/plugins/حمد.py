...
@app.on_message(filters.private & command("طريقة تشغيل ارنوب"))
async def addbot(client: Client, message: Message):
    await message.reply_text(f"""- **هلا والله ياعيني عشان تفعل بوت ارنوب اتبع الخطوات الي بالاسفل**
1 • ضيف البوت لكروبك 
2 • ارفعه مشرف بكل الصلاحيات 
3 • لو تريد تشوف الاوامر اكتب [ م الاوامر ] ولو تبي تشغل على طول اكتب حمد شغل + اسم المقطع الصوتي
•مثال: ارنوب شغل حاسد روحي
- لو واجهت مشكله او ما فهمت خطوة كلم مطور البوت ~ @Ng_103""",
...
async def addbot(client: Client, message: Message):
    await message.reply_text(f"""**- اهلين فيك بسورس ارنوب ياحلو
• لو تبي تنصب مثل هالبوت تواصل مع مطور السورس
• عندك استفسار او اقتراح بخصوص البوت تواصل مع مطور البوت**
مطور السورس -› [𓏺𝓷𝓪𝓭𝓮𝓻 ∥ 𓏺نِاެدَࢪ 🪐](t.me/Ng_103)
قناة السورس -› [𝑠𝑜𝑢𝑟𝑐𝑒 𝑎𝑟𝑛𝑜𝑝 ‌ㇱ](t.me/N_G_122)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
